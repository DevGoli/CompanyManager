...
* You will need to create an addins directory either within your content directory (where Skyve will look by default), or configure `addins: { directory:` within your `companyManager.json` to the location of the addins directory.
